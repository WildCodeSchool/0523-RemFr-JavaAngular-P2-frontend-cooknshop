...
@NgModule({
  declarations: [AppComponent, DemoPageComponent, DemoComponent, DemoPipe, DemoDirective, HeaderComponent, AccueilComponent, BouttonFavComponent, RechercheComponent, BouttonNewRecetteComponent, NewRecetteComponent, InscriptionComponent, ConnexionComponent, DetailsRecetteComponent, PanierRecettesComponent, ListeCoursesComponent],
